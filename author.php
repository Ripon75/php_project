<?php include 'header.php'; ?>
 ...
 <?php
    ...
    ?>
        <h2 class="page-heading"><?php echo strtoupper($row_new['user_name']); ?></h2>
...
<?php
   ...
   $offset = ($page_number -1)*$limit;
    ...
    $query = "SELECT post.post_id, post.title, post.description, post.post_img, post.post_date, post.category, category.category_name, user.user_name, post.author FROM post
            ...
            <div class="inner-content clearfix">
                ...
                <div class="post-information">
                    ...
                    <span>
                        ...
                        <a href='author.php?author_id=<?php echo $row['author'] ?>'><?php echo $row['user_name'] ?></a>
                    </span>
                    <span>
